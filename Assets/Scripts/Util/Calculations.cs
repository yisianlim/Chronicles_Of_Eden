...
public class Calculations{
    ...
    /// <returns></returns>
    public static Vector3 determineRequiredLaunchVelocityToReachPoint(Vector3 startPos, Vector3 endPos, float arcHeightDifferece)
    {

        Vector3 displacement = endPos - startPos; //The distance traveled along each of the axes.
        float arcMaxHeight = displacement.y + arcHeightDifferece;
